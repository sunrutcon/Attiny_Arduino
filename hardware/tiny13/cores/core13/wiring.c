...
/*The following improvedd micros() code was contributed by an unknown sourceforge user
  if this was you, please notify me! */
unsigned long micros(){
	...
	#elif F_CPU == 16000000
	x = ovrf * 16;
	#else #error This CPU frequency is not defined
	#endif
	asm("sei");
	return x; 
}
